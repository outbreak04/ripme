...
public class nudeslolRipper extends AbstractHTMLRipper {

    public nudeslolRipper(URL url) throws IOException {
        super(url);
    }
    ...
    public String getGID(URL url) throws MalformedURLException {
        Pattern p = Pattern.compile("^https?://[wm.]*nudes\\.lol/g/([a-zA-Z0-9]+).*$");
